...
function getAllProducts(shop_id) {
  ...
  .innerJoin('platforms', 'products.platform_id', 'platforms.id')
  .select('stores.id as store_id', 'platform.name', 'listing_id', 'quantity', 'image', 'title', 'shop_id', 'products.id as product_id')
