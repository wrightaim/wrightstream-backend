  ...
  return knex('staff').del()
    .then(function () {
      return knex('staff').insert([
        {id: 1, shop_id: 1, role_id: 1, first_name: 'Claudia', last_name: 'Ligidakis', email: 'claudia@test', password: '$2a$10$5yNsaFcMNnq69yzo88MN5O9GTg29K/wbwzDVz7HBQn/f7L9Rb6Lk6', photo: '$2a$10$5yNsaFcMNnq69yzo88MN5O9GTg29K/wbwzDVz7HBQn/f7L9Rb6Lk6', photo: 'https://www.healthypawspetinsurance.com/Images/V3/DogAndPuppyInsurance/Dog_CTA_Desktop_HeroImage.jpg'},
